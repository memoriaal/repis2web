...
MODE=update SOURCE=${csv_filename} ES_INDEX=emem_persons E8_CREDENTIALS="${ES8_CREDENTIALS}" ES_HOST="${ES8_HOST}" node repis2es.js #  | grep Uploaded
